import styles from "./myprofile-auditor.module.scss"
...
export default function MyProfileAuditor() {
                ...
                <div className={styles.profile__container}>
                    <div className={styles.profile__userdata}>
                        <section className={styles.profile__userdata__photo}>
                            <Image width={250} height={250} src="/image-avatar-big-boy.png" alt="" />
                            <div className={styles.profile__useredit} >
                                <Image width={21} height={21} src="/icons/edit-icon.png" alt="" />
                            </div>
                            <Image width={100} height={100} src="/degrade-pink.png" alt="" className={styles.profile__degradephoto} />
                        </section>
                        <section className={styles.profile__userdata__data}>
                            ...
                            <div>
                                <span className={styles.profile__userdata__aboutmetext}>Experience</span>
                                <span>Lorem ipsum</span>
                            </div>
                            <div>
                                <span className={styles.profile__userdata__aboutmetext}>Rates</span>
                                <span>Lorem ipsum</span>
                            </div>
                            <div>
                                <span className={styles.profile__userdata__aboutmetext}>Total Bounties</span>
                                <span>Lorem ipsum</span>
                            </div>
                        </section>
                    </div>
